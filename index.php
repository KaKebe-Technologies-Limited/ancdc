...
<html lang="en">
  ...
  <div class="block-31" style="position: relative;">
    <div class="owl-carousel loop-block-31 ">
      <div class="block-30 block-30-sm item" style="background-image: url('images/yf.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-7">
              <h2 class="heading mb-5">ANCDC.</h2>
              <!-- section for a video  -->
      ...
      <div class="row">
        <div class="col-md-4 pr-5">
          <div class="block-48">
              ...
              <div class="block-48-counter ftco-number" data-number="438">0</div>
              <span class="block-48-text-1 mb-4 d-block">Children in communities</span>
    ...
    <div class="container">
      <div class="row mb-3 justify-content-center">
        <div class="col-md-8 text-center">
          ...
          <p class="lead">Some of the latest activities happening in and around our organization.</p>
          <p><a href="#" class="link-underline">View All Activities</a></p>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-12 block-11">
          <div class="nonloop-block-11 owl-carousel">
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="images/yf.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">Youth Sports Team</a></h3>
                <p class="card-text">Youth camp  and All Nations Child Development Centre Sport Team to bring unity and togetherness</p>
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="images/yf.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">Empowering Caregivers: Income Generation Training</a></h3>
                <p class="card-text">Caregivers trained in Income generating activity, Compassion staff looks on products from livelihood skill of beneficiaries.</p>
                <!--<span class="donation-time mb-3 d-block">Last donation 1w ago</span>-->
                <div class="progress custom-progress-success">
                  <div class="progress-bar bg-primary" role="progressbar" style="width: 100%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="images/yf.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">Material Giftings through passout</a></h3>
                <p class="card-text">Beneficiaries posed with bed sheets and grandaunts posed during pass out program.</p>
                <!--<span class="donation-time mb-3 d-block">Last donation 1w ago</span>-->
                <div class="progress custom-progress-success">
                  <div class="progress-bar bg-primary" role="progressbar" style="width: 100%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="images/yf.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">Talent and Skills </a></h3>
                <p class="card-text">Brass band performance by project children and hair dressing session on the left. </p>
                <!--<span class="donation-time mb-3 d-block">Last donation 1w ago</span>-->
                <div class="progress custom-progress-success">
                  <div class="progress-bar bg-primary" role="progressbar" style="width: 100%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="images/yf.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">Moments of Happiness</a></h3>
                <p class="card-text">Birthday party (beneficiaries and Umbrella Partner) and Birthday celebration with a sponsor at the home of child No. UG092700300 during sponsor visit in 2018.</p>
                <!--<span class="donation-time mb-3 d-block">Last donation 1w ago</span>-->
                <div class="progress custom-progress-success">
               <div class="progress-bar bg-primary" role="progressbar" style="width: 100%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            ...
            <div class="card fundraise-item">
              ...
              <div class="card-body">
                <h3 class="card-title"><a href="#">Empowering Caregivers: Income Generation Training</a></h3>
                <p class="card-text">Beneficiary’s family receive goats, maize, toilet, and relief food from CIV fund..</p>
                <!--<span class="donation-time mb-3 d-block">Last donation 1w ago</span>-->
                <div class="progress custom-progress-success">
                  <div class="progress-bar bg-primary" role="progressbar" style="width: 100%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="images/yf.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">Health is Wealth</a></h3>
                <p class="card-text">Health start-up kit handover, letter writing and health screening going on</p>
                <!--<span class="donation-time mb-3 d-block">Last donation 1w ago</span>-->
                <div class="progress custom-progress-success">
                  <div class="progress-bar bg-primary" role="progressbar" style="width: 100%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
        ...
        <div class="col-md-6 col-lg-3 mb-5">
          <div class="person-donate text-center">
            ...
            <div class="donate-info">
              <h2>Sedrick Otolo</h2>
              <span class="time d-block mb-3">Donated</span>
              <p>Donated <span class="text-success">$252</span> <br> <em>for</em> </p>
            </div>
          </div>    
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 pl-md-5">
          ...
          <h2>Water Is Life. We Successfuly Provide Clean Water in Lira City</h2>
          <p class="mb-3">With great support from the donors, we have managed to provide clearn water to the communities of Lira City</p>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="post-entry">
            <a href="#" class="mb-3 img-wrap">
              <img src="images/news01.JPG" alt="Image placeholder" class="img-fluid">
            </a>
            <h3><a href="#">Be A Volunteer Today </a></h3>
            <span class="date mb-4 d-block text-muted">July 26, 2022</span>
            <p>Join our team today and become a Volunteer at the organization at the Sports Academy</p>
  ...
  <div class="featured-section overlay-color-2" style="background-image: url('images/stake.JPG');">
    
    <div class="container">
      <div class="row">

        <div class="col-md-6 mb-5 mb-md-0">
          <img src="images/stake.JPG" alt="Image placeholder" class="img-fluid">
        </div>
