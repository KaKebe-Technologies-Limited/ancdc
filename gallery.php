...
<html lang="en">
  ...
  <div class="block-31" style="position: relative;">
    <div class="owl-carousel loop-block-31 ">
      <div class="block-30 block-30-sm item" style="background-image: url('images/bg003.JPG');" data-stellar-background-ratio="0.5">
        <div class="container">
    ...
    <div class="container mt-5">
      <div align="center">
        <button class="btn btn-default filter-button" data-filter="all" style="">All</button>
        <button class="btn btn-default filter-button" data-filter="image1" style="color: black;">image1</button>
        <button class="btn btn-default filter-button" data-filter="image2" style="color: black;">image2</button>
        <button class="btn btn-default filter-button" data-filter="image3" style="color: black;">image3</button>
        <button class="btn btn-default filter-button" data-filter="image4" style="color: black;">image4</button>
    </div>
    <div class="row pt-5">
      <div class="col-md-4 filter image1">
        <a href="images/img_1.jpg" class="img-hover" data-fancybox="gallery">
          <span class="icon icon-search"></span>
          <img src="images/img_1.jpg" alt="Image placeholder" class="img-fluid">
        </a>
      </div>
      <div class="col-md-4 filter image2">
      ...
      <div class="col-md-4 filter image3">
      ...
      <div class="col-md-4 filter image4">
